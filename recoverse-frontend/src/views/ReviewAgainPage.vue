<template>
  <section class="reviewPage">
    ...
    <main v-if="reflections.length" class="reviewLayout">
      ...
      <section class="panel memoryPanel">
        ...
        <div v-else class="empty">
          이 기억에는 아직 다시 읽을 답변이 없어요. 상세 화면에서 이어 쓰면 이곳에 답변 카드가 나타납니다.
        </div>
      </section>
      ...
      <aside class="panel comparePanel">
        ...
        <div v-else class="empty">
          같은 질문에 답한 기억이 더 쌓이면, 이곳에서 시기별로 달라진 답을 볼 수 있어요.
        </div>
      </aside>
    </main>
    ...
    <main v-else class="emptyState">
      ...
      <p>먼저 기억 작성 탭에서 짧은 질문 하나에 답해보세요. 답변이 생기면 이곳에서 시기와 질문별로 다시 열 수 있어요.</p>
    </main>
  </section>
</template>
