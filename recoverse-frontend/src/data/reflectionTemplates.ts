...
const questionHints: Record<string, string> = {
  year_place: "사진첩을 넘기듯 올해 자주 갔거나 다시 떠오르는 장소를 하나 골라보세요.",
  year_food: "누구와 먹었는지, 그때의 분위기까지 한 줄로 붙이면 기억이 더 선명해져요.",
  year_song: "많이 들은 이유나 그 노래가 틀어지던 순간을 같이 적어보세요.",
  year_scene_best_day: "날짜가 정확하지 않아도 좋아요. 그날의 장면, 사람, 기분 중 하나부터 시작하세요.",
  year_thankful_person: "큰 도움보다도 올해 마음에 남은 말이나 행동을 떠올려보세요.",
  year_new_connection: "새 친구, 동료, 단골집 사장님처럼 올해 새로 생긴 관계를 적어보세요.",
  year_content: "영화, 책, 유튜브, 게임처럼 자주 꺼내본 콘텐츠와 좋았던 이유를 남겨보세요.",
  year_phrase: "내가 자주 말했거나 주변에서 자주 들은 말을 떠올려보세요.",
  year_changed: "습관, 관계, 일상 리듬처럼 작지만 이전과 달라진 점을 적어보세요.",
  year_achievement: "남에게 설명하기 큰 성취가 아니어도 괜찮아요. 내가 해냈다고 느낀 일을 고르세요.",
  year_difficult: "아직 정리되지 않았다면 사건 이름만 적어도 충분해요.",
  year_thought: "올해 머릿속을 자주 맴돈 걱정, 질문, 다짐 중 하나를 적어보세요.",
  year_bright_day: "웃음이 났던 순간이나 마음이 가벼워졌던 장면부터 적어보세요.",
  year_one_word: "정답보다 별명이 좋아요. 올해에 붙이고 싶은 단어 하나를 골라보세요.",
  year_next_me: "응원, 부탁, 경고 중 지금의 내가 1년 뒤에 듣고 싶은 말을 남겨보세요.",
  year_jan_first: "올해를 시작하던 나에게 알려주고 싶은 한 가지를 적어보세요.",
  travel_first_scene: "도착, 이동, 숙소, 길거리처럼 제일 먼저 떠오르는 화면을 그대로 묘사해보세요.",
  travel_sense: "맛, 소리, 냄새, 날씨처럼 몸이 먼저 기억하는 감각을 적어보세요.",
  travel_unexpected: "계획과 달랐지만 기억에 남은 일이나 의외로 좋았던 순간을 떠올려보세요.",
  travel_main_emotion: "즐거움, 피곤함, 설렘처럼 가장 오래 남은 감정 하나부터 적어보세요.",
  travel_after_feeling: "돌아온 뒤 계속 남았던 여운, 아쉬움, 다시 가고 싶은 마음을 적어보세요.",
  travel_people: "같이 간 사람뿐 아니라 여행 중 스친 얼굴이나 대화도 좋아요.",
  travel_meaning: "그때의 나에게 필요했던 쉼, 용기, 전환점 같은 의미를 붙여보세요.",
  period_scene: "이 시기를 대표하는 하루나 장소 하나를 골라 짧게 남겨보세요.",
  period_place: "집, 회사, 학교, 산책길처럼 오래 머물렀던 공간과 그 이유를 적어보세요.",
  period_self_word: "그 시기의 나에게 붙일 수 있는 별명이나 상태를 적어보세요.",
  period_thought: "자주 떠올린 고민, 기대, 질문을 한 문장으로 남겨보세요.",
  period_changed: "생활 패턴, 마음가짐, 관계처럼 전후가 달라진 지점을 적어보세요.",
  period_future_message: "이 시기를 지나온 나에게 남기고 싶은 격려나 메모를 적어보세요.",
  life_self_word: "그 나이의 나를 한 사람처럼 소개한다면 어떤 모습이었는지 적어보세요.",
  life_choice: "큰 결정뿐 아니라 그때의 방향을 바꾼 작은 선택도 좋아요.",
  life_people: "오래 곁에 남았거나 지금의 나에게 영향을 준 관계를 떠올려보세요.",
  life_taste: "음악, 취미, 일하는 방식처럼 지금까지 남은 취향의 시작을 적어보세요.",
  life_release: "이제는 조금 다르게 볼 수 있는 후회나 미련을 안전하게 적어보세요.",
  life_next_message: "다음 시기의 내가 잊지 않았으면 하는 태도나 약속을 남겨보세요.",
};
