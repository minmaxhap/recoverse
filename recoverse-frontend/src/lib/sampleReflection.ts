...
const sampleAnswers: Record<string, string> = {
  travel_first_scene: "바다 앞 작은 식당에서 따뜻한 라면을 먹던 시간",
  travel_sense: "짠 바람 냄새, 젖은 돌담, 숙소로 돌아가던 길의 조용한 음악",
  travel_unexpected: "계획한 코스보다 우연히 들어간 골목이 더 오래 기억에 남았어요.",
  travel_main_emotion: "편안함과 조금의 해방감",
  travel_after_feeling: "내가 생각보다 느린 시간을 좋아한다는 걸 알게 되었어요.",
  travel_people: "말없이 풍경을 같이 보던 친구 얼굴",
  travel_meaning: "나를 다시 천천히 돌려놓은 여행",
};
